...
func (in *CodingTaskStatus) DeepCopyInto(out *CodingTaskStatus) {
	*out = *in
	...
	if in.ProviderSelectionCommentID != nil {
		in, out := &in.ProviderSelectionCommentID, &out.ProviderSelectionCommentID
		*out = new(int64)
		**out = **in
	}
	if in.SelectedProvider != nil {
		in, out := &in.SelectedProvider, &out.SelectedProvider
